...
call HL('eeComment', 'gravel', '', 'none')
call HL('eeCondtional', 'dress', '', 'none')
call HL('eeTag', 'orange', '', 'none')
call HL('eePreload', 'lime', '', 'none')
call HL('eeProperty', 'dirtyblonde', '', 'none')
call HL('eeParameter', 'coffee', '', 'none')
call HL('eeBlock', 'darkroast', '', 'none')
