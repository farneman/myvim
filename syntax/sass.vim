...
syn cluster sassCssAttributes contains=css.*Attr,scssComment,cssColor,cssURL,sassDefault,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape,cssRenderProp
